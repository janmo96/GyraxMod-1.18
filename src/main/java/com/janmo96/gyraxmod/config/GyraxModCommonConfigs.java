...
public class GyraxModCommonConfigs
{
    ...
    public static final ForgeConfigSpec.ConfigValue<String> MoneyText;
    public static final ForgeConfigSpec.ConfigValue<String> IpMessage;
    public static final ForgeConfigSpec.ConfigValue<Integer> DefaultMoneyValue;
    ...
    static {
        ...
        MoneyText= BUILDER.comment("Message Sent To Players when they run /money")
                .define("Money Message:", "You Have = {amount}$");

        DefaultMoneyValue= BUILDER.comment("Default Amount Set For New Players")
                .define("Default Amount Of $:", 50);
        //Here Define Configs
